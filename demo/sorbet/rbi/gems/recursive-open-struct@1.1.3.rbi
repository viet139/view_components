...
class RecursiveOpenStruct < ::OpenStruct
  ...
  #
  # source://recursive-open-struct//lib/recursive_open_struct.rb#30
  def initialize(hash = T.unsafe(nil), passed_options = T.unsafe(nil)); end

  # source://recursive-open-struct//lib/recursive_open_struct.rb#75
  def [](name); end

  # source://recursive-open-struct//lib/recursive_open_struct.rb#96
  def []=(name, value); end

  # source://recursive-open-struct//lib/recursive_open_struct.rb#162
  def delete_field(name); end

  # Adapted implementation of method_missing to accommodate the differences
  # between ROS and OS.
  #
  # source://recursive-open-struct//lib/recursive_open_struct.rb#111
  def method_missing(mid, *args); end

  # TODO: Rename to new_ostruct_member! once we care less about Rubies before
  # 2.4.0.
  #
  # source://recursive-open-struct//lib/recursive_open_struct.rb#137
  def new_ostruct_member(name); end

  # source://recursive-open-struct//lib/recursive_open_struct.rb#54
  def to_h; end
  ...
  # source://recursive-open-struct//lib/recursive_open_struct.rb#187
  def _create_sub_element_(hash, **overrides); end

  # source://recursive-open-struct//lib/recursive_open_struct.rb#181
  def _get_key_from_table_(name); end

  # source://recursive-open-struct//lib/recursive_open_struct.rb#172
  ...
  # source://recursive-open-struct//lib/recursive_open_struct.rb#191
  ...
  # @return [Boolean]
  #
  # source://recursive-open-struct//lib/recursive_open_struct.rb#104
